...
- 주요 속성: 사용자ID, CJ WORLD ID(email_alias), 암호화된 CJ WORLD PW(참조, CJ 자동화 로그인용, 복호화 가능), **앱 로그인 비밀번호 해시(단방향, 이 서비스 자체 로그인용)**, **텔레그램 사용자ID(딥링크로 확보, 위조 불가 — 텔레그램 채널 추가 시 사용, 현재는 미사용)**, 등록 승인 일시, 동의 철회 여부, **선호 회의실 목록(우선순위 순서, 가입 시 입력)**

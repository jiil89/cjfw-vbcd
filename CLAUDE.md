...
- `prompts/prd.txt` — PRD. 인프라 구성(Vercel+Supabase), 인증/보안(JWT access+refresh) 결정사항, 진행 상태
...
- `docs/service-scenarios.md` — 사용자 시나리오 11개
- `docs/swagger.json` — 백엔드 API 계약(OpenAPI 3.0)
- `docs/design/chatbot-shell.html` — 웹 챗봇 UI 목업 (Intercom 디자인 시스템 기반)
